...
export default function RationsStorePage() {
  ...
  const renderProductCard = (product: StoreProduct) => {
    ...
    return (
      <Card 
        key={product.id} 
        className="bg-black border-2 border-zinc-700 rounded-none shadow-[4px_4px_0px_0px_rgba(252,208,0,0.3)] hover:shadow-[6px_6px_0px_0px_rgba(252,208,0,0.4)] transition-all"
      >
        <CardContent className="p-4">
          {product.imageUrl ? (
            <div className="w-full h-32 mb-3 bg-zinc-900 border border-zinc-700 rounded-none overflow-hidden">
              <img src={product.imageUrl} alt={product.name} className="w-full h-full object-cover" />
            </div>
          ) : (
            <div className="w-full h-32 mb-3 bg-zinc-900 border border-zinc-700 rounded-none flex items-center justify-center">
          ...
          <div className="flex items-start justify-between mb-2">
            ...
            {product.isVipOnly && (
              <Badge className="bg-ministry-gold text-black text-[10px] font-bold uppercase ml-2 flex-shrink-0 rounded-none">
                VIP
              </Badge>
            )}
          </div>
          ...
          {product.discountValue && (
            <Badge className="bg-green-900 text-green-400 text-xs mb-3 rounded-none border border-green-700">
              {product.discountValue}
            </Badge>
          )}
          ...
          <Button
            ...
            className={`w-full mt-3 rounded-none font-bold uppercase tracking-wide ${
              canRedeem
    ...
    <div className="pb-20 bg-background min-h-screen">
        ...
        <Card className="bg-black/50 border-2 border-ministry-gold rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 liquid-gold-card border-2 border-black rounded-none flex items-center justify-center shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
              ...
              {isVip && (
                <Badge className="bg-ministry-gold text-black font-bold uppercase rounded-none border-2 border-black">
      ...
      <div className="px-4 py-4">
        <Tabs defaultValue="bronze" className="w-full">
          <TabsList className="grid w-full grid-cols-3 bg-zinc-900 rounded-none border-2 border-zinc-700 p-1">
            <TabsTrigger 
              value="bronze" 
              className="rounded-none data-[state=active]:bg-orange-800 data-[state=active]:text-white font-bold uppercase text-xs"
            >
              Bronze
            </TabsTrigger>
            <TabsTrigger 
              value="silver"
              className="rounded-none data-[state=active]:bg-zinc-600 data-[state=active]:text-white font-bold uppercase text-xs"
            >
              Silver
            </TabsTrigger>
            <TabsTrigger 
              value="gold"
              className="rounded-none data-[state=active]:bg-yellow-700 data-[state=active]:text-ministry-gold font-bold uppercase text-xs"
            >
              Gold
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="bronze" className="mt-4">
            <div className="mb-4 p-3 bg-orange-950 border-2 border-orange-800 rounded-none">
          ...
          <TabsContent value="silver" className="mt-4">
            <div className="mb-4 p-3 bg-zinc-900 border-2 border-zinc-600 rounded-none">
              <div className="flex items-center gap-2 mb-1">
          ...
          <TabsContent value="gold" className="mt-4">
            <div className="mb-4 p-3 bg-yellow-950 border-2 border-ministry-gold rounded-none">
              <div className="flex items-center gap-2 mb-1">
      ...
      <Dialog open={showRedeemDialog} onOpenChange={setShowRedeemDialog}>
        <DialogContent className="bg-black border-2 border-ministry-gold rounded-none max-w-sm">
          <DialogClose className="absolute right-4 top-4 w-8 h-8 flex items-center justify-center bg-black border-2 border-white rounded-none text-white hover:bg-zinc-800">
            ✕
          </DialogClose>
          <DialogHeader>
          ...
          {selectedProduct && (
            <div className="py-4">
              <div className="bg-zinc-900 border border-zinc-700 p-4 rounded-none mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="col-span-2">
                      ...
                      <Input
                        ...
                        className="bg-zinc-900 border-zinc-700 rounded-none text-white"
              ...
              <div className="mt-4 p-3 bg-zinc-900 border border-zinc-700 rounded-none">
          ...
          <DialogFooter className="gap-2">
            <Button
              ...
              className="rounded-none border-2 border-zinc-600 text-white hover:bg-zinc-800"
            >
              Cancel
            </Button>
            <Button
              ...
              className="bg-ministry-gold text-black font-bold uppercase rounded-none border-2 border-black hover:bg-yellow-500"
            >
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="bg-black border-2 border-ministry-gold rounded-none max-w-sm">
          ...
          <div className="flex flex-col items-center py-6">
            <div className="w-16 h-16 bg-green-900 border-2 border-green-500 rounded-none flex items-center justify-center mb-4">
          ...
          <DialogFooter>
            <Button
              ...
              className="w-full bg-ministry-gold text-black font-bold uppercase rounded-none border-2 border-black hover:bg-yellow-500"
            >
              Continue Shopping
            </Button>
          </DialogFooter>
