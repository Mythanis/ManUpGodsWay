      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <BookOpen className="h-4 w-4 text-ministry-gold" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Activity className="h-4 w-4 text-ministry-gold" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <MessageSquare className="h-4 w-4 text-ministry-gold" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-ministry-charcoal">{profile.forumPosts}</div>
            <p className="text-xs text-ministry-slate">Discussions & replies</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {tierInfo.icon && <div className={tierInfo.color}>{tierInfo.icon}</div>}
          </CardHeader>
          <CardContent>
