            ...
            <Card className="bg-black border-ministry-gold-exact">
              ...
              <CardContent className="space-y-6 text-gray-300">
                ...
                <div className="border-t border-ministry-gold-exact/30 pt-6">
                  <h3 className="text-xl font-bold text-ministry-gold-exact mb-4">Benefits of Starting or Joining a War Group</h3>
                ...
                <div className="border-t border-ministry-gold-exact/30 pt-6">
                  <h3 className="text-xl font-bold text-ministry-gold-exact mb-4">War Groups HQ</h3>
                ...
                <div className="pt-4">
                  <Button
                    onClick={() => navigate('/war-groups/register')}
                    className="w-full bg-ministry-gold-exact text-black hover:bg-yellow-500 font-bold py-6"
