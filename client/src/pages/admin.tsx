...
import { Plus, Video, Bell, Activity } from "lucide-react";
    ...
    <div className="pb-20">
      ...
      <div className="px-6 mb-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <Button 
            variant="outline"
            className="bg-ministry-steel text-white p-4 rounded-2xl hover:bg-ministry-navy border-none flex items-center space-x-3"
          ...
          <Button 
            variant="outline"
            className="bg-ministry-gold text-ministry-navy p-4 rounded-2xl hover:bg-ministry-gold/90 border-none flex items-center space-x-3"
