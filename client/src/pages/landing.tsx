    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-gradient-to-br from-ministry-charcoal to-ministry-steel dark:from-header-dark dark:to-ministry-charcoal text-white px-6 pt-16 pb-12">
        <div className="text-center">
          ...
          <Button 
            ...
            className="bg-ministry-gold text-ministry-charcoal hover:bg-ministry-gold/90 text-lg px-8 py-3 rounded-xl font-bold"
      ...
      <div className="px-6 py-12 bg-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <Card className="border border-ministry-charcoal shadow-lg bg-ministry-gold-exact" data-testid="card-bible-studies">
          ...
          <Card className="border border-ministry-charcoal shadow-lg bg-ministry-gold-exact" data-testid="card-video-content">
            <CardContent className="p-8">
              <div className="text-ministry-steel mb-4">
                <Video size={48} />
              </div>
          ...
          <Card className="border border-ministry-charcoal shadow-lg bg-ministry-gold-exact" data-testid="card-community">
            <CardContent className="p-8">
          ...
          <Card className="border border-ministry-charcoal shadow-lg bg-ministry-gold-exact" data-testid="card-progress">
            <CardContent className="p-8">
              <div className="text-black mb-4">
                <Users size={48} />
              </div>
        ...
        {/* CTA Section */}
        <div className="text-center">
          <Card className="bg-gradient-to-r from-ministry-steel to-ministry-charcoal border-none" data-testid="card-cta">
