      ...
      <div className="px-6 py-6">
        <Card className="liquid-black border-2 border-ministry-gold-exact overflow-hidden rounded-none shadow-[4px_4px_0px_0px_rgba(252,208,0,1)]">
          <CardContent className="p-6 text-white space-y-6">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">3. How We Use Your Information</h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-2">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">4. Third-Party Services</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">5. Data Retention</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">6. Security</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">7. Your Rights & Data Deletion</h2>
              <p className="text-gray-300 text-sm leading-relaxed mb-2">
                You may request:
              </p>
              <ul className="list-disc list-inside text-gray-300 text-sm space-y-1 ml-2">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mt-2">
                Email: <a href="mailto:jody@manupgodsway.org" className="text-ministry-gold-exact hover:underline">jody@manupgodsway.org</a>
              </p>
            </section>

            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">8. Children's Privacy</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">9. No Tracking</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">10. Changes</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-lg font-bold text-ministry-gold-exact uppercase mb-2">11. Contact</h2>
              <p className="text-gray-300 text-sm leading-relaxed">
