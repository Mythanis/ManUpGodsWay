        ...
        <Card className="bg-ministry-gold-exact border-2 border-black">
          ...
          <CardContent className="space-y-4">
            ...
            <Button 
              ...
              className="w-full bg-black hover:bg-gray-900 text-black font-bold text-lg py-6 rounded-xl shadow-lg border-2 border-black transition-all hover:scale-[1.02]"
