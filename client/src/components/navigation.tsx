...
import { Home, BookOpen, Video, Users, MessageCircle, Settings, Headphones, Trophy, ChevronLeft, ChevronRight, ExternalLink, Heart, UserPlus, Dumbbell, Shield, Crown, Book, Calendar } from "lucide-react";
